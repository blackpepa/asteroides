 ...
 */
class Posts_Carousel extends The7_Elementor_Widget_Base {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .portfolio-shortcode .project-links-container a > svg'         => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .portfolio-shortcode .project-links-container a:hover > svg' => 'fill: {{VALUE}};',
				],
			]
		);
