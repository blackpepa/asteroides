...
class Categories_List extends The7_Elementor_Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'skin'        => 'inline',
				'label_block' => false,
				'description' => esc_html__( 'If none is selected, inherits from “Main level” icon', 'the7mk2' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .dt-categories-list > li > a svg'                => 'fill: {{VALUE}};',
				],
				'condition' => [
					'selected_icon[value]!' => '',
					'submenu_display'       => 'on_click',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .dt-categories-list > li > a .next-level-button:hover svg' => 'fill: {{VALUE}};',
				],
				'condition' => [
					'selected_icon[value]!' => '',
					'submenu_display'       => 'on_click',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .dt-categories-list > li.open-sub > a .next-level-button' => 'color: {{VALUE}};',
					'{{WRAPPER}} .dt-categories-list > li.open-sub > a svg'                 => 'fill: {{VALUE}};',
				],
				'condition' => [
					'selected_icon[value]!' => '',
					'submenu_display'       => 'on_click',
		...
		$selector = '{{WRAPPER}} .dt-categories-list > li > a .count';
		...
		$this->add_control(
			...
			[
				...
				'selectors'            => [
					'{{WRAPPER}} .dt-categories-list > li > a' => ' {{VALUE}};',
				],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .dt-sub-menu-display-on_click .children > li > a .next-level-button:hover svg, {{WRAPPER}} .dt-sub-menu-display-on_item_click .children > li > a:hover .next-level-button svg'                                    => 'fill: {{VALUE}};',
				],
				'condition' => [
					'selected_icon[value]!' => '',
					'submenu_display'       => 'on_click',
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .children li.open-sub > a .next-level-button' => 'color: {{VALUE}};',
					'{{WRAPPER}} .children li.open-sub > a svg'                => 'fill: {{VALUE}};',
				],
				'condition' => [
					'selected_icon[value]!' => '',
					'submenu_display'       => 'on_click',
		...
		$selector = '{{WRAPPER}} .dt-categories-list  .children .count';
	...
	protected function add_items_count_tab_controls( $prefix_name, $box_name ) {
		...
		$selector = '{{WRAPPER}} .dt-categories-list > li' . $extra_class . ' > a' . $is_hover . ' .count';
