...
class Login extends The7_Elementor_Widget_Base {
	...
	protected function the7_title() {
		return esc_html__( 'Login', 'the7mk2' );
	}
	...
	protected function add_logged_out_controls() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( 'Enter your text', 'the7mk2' ),
				'label_block' => true,
			]
		);
	...
	protected function add_box_content_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .the7-login-wrapper' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .the7-login-wrapper' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .the7-login-wrapper:hover' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .the7-login-wrapper:hover' => 'border-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Box Shadow', 'the7mk2' ),
				'selector' => '{{WRAPPER}} .the7-login-wrapper:hover',
			]
		);
	...
	protected function add_icon_style_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .elementor-icon i { transition: color 0.3s ease; } {{WRAPPER}} .elementor-icon svg { transition: fill 0.3s ease; } {{WRAPPER}} .the7-login-wrapper:hover .elementor-icon i'     => 'color: {{VALUE}};',
					'{{WRAPPER}} .the7-login-wrapper:hover .elementor-icon svg' => 'fill: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .the7-login-wrapper:hover .elementor-icon' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'   => '',
				'selectors' => [
					'{{WRAPPER}} .the7-login-wrapper:hover .elementor-icon' => 'background: {{VALUE}};',
				],
			]
		);
